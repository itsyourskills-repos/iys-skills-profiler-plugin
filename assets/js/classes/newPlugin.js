...
//   }
  ...
  saveTheSoftSkillComment(
    ...
    if (isLoginUser) {
      ...
      fetchData(url, "GET")
        .then((response) => {
            console.log(response,"isot_file");
          if (parentSkillDetailId) {
            console.log("creating parent for you", parentSkillDetailId);
            addTolocalStorage({
              comment: commentValue,
  ...
  changeSoftSkillRateModelElement(skillDetail, parentSkillDetailId) {
    console.log(skillDetail,"skillDetail");
    console.log(parentSkillDetailId,"parentSkillDetailId");
    const RateSkillModel = document.getElementById("RateSkillModel");
    const RateSkillModelLabel = document.getElementById("RateSkillModelLabel");
  ...
  createSkillPath(htmlElement, skillList) {
    ...
    skillList.forEach((skill, index) => {
      ...
      if (index === skillList.length - 1) {
        ...
        li.style="background-color:white; padding-right:16px; padding-left:16px; padding-top:4px; padding-bottom:4px; border-radius:7px; box-shadow:rgba(0,0,0,0.1) 0px 6px 12px;";
      } else {
        li.addEventListener("click", (event) => {
  ...
  createSoftSkillRatingElement(htmlElement, skillDetail, parentSkillDetailId, objExist) {
    console.log(htmlElement);
    // add exception for rating
    try {
      htmlElement.noUiSlider.destroy();
    ...
    for (const tagsString in groupedSkills) {
      ...
      skillsGroup.forEach((skill) => {
        ...
        if (percentage === 0) {
          ...
          image0.src = imagePathBase + '0rate.svg';
        ...
        if (percentage === 25) {
          ...
          image25.src = imagePathBase + '25rate.svg';
        ...
        if (percentage === 50) {
            ...
            image50.src = imagePathBase + '50rate.svg';
        ...
        if (percentage === 75) {
            ...
            image75.src = imagePathBase + '75rate.svg';
        ...
        if (percentage === 100) {
            ...
            image100.src = imagePathBase + '100rate.svg';
  ...
  handleHardSkillsClick() {
    ...
    renderSkills(skills, breadcrumbPath, softSkillAccordian) {
      ...
      skills.forEach(skill => {
          ...
          if (skill.proxy_skill) {
              skillButton.setAttribute("title", skill.proxy_skill.name);
          } else {
              skillButton.setAttribute("title", "");
          }
          ...
          // Add star icon if the skill has ratings
          if (ratingsCount > 0) {
              const starIcon = document.createElement("i");
              starIcon.className = "fas fa-star";
              starIcon.style.marginLeft = "5px";
              ...
              skillButton.appendChild(starIcon);
          }
    ...
    renderBreadcrumb(skills, breadcrumbPath, softSkillAccordian) {
      ...
      const ratingsLength = skills.ratings ? skills.ratings.length : 0;
        if (breadcrumbPath.length >0 && skills.child_count > 0 && ratingsLength > 0) {
            ...
            rateButtonSpan.style.color = "#4F46FB";
            rateButtonSpan.style.fontSize = "16px";
            rateButton.appendChild(rateButtonStar);
            rateButton.appendChild(rateButtonSpan);
            rateButton.addEventListener("click", () => {
                this.changeSoftSkillRateModelElement(skills);
            });
    ...
    renderRelatedHardSkills(skills, breadcrumbPath, softSkillAccordian, skillId) {
        ...
        skills.forEach(skill => {
            ...
            if (ratingsCount > 0 && childCount==0) {
              const starIcon = document.createElement("i");
              starIcon.className = "fas fa-star";
              starIcon.style.marginLeft = "5px";
              starIcon.style.cursor = "pointer";
