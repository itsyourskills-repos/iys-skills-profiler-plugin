...
let oldData = [
  {
    skill_id: "13074779",
    skill_name: "AWS Consultant",
    uid: "13074779",
    has_direct_child_skills: 4,
    has_indirect_child_skills: 0,
    has_siblings_skills: 0,
    has_relatives_skills_categories: 0,
    rating: 2,
  ...
  {
    skill_id: "13149404",
    skill_name: "Django Backend Developer",
    uid: "13149404",
    has_direct_child_skills: 4,
    has_indirect_child_skills: 0,
    has_siblings_skills: 0,
...
let oldFormatData = reduceToOldFormat(previousData);
let newFormatData = JSON.stringify(reduceToNewFormat(oldFormatData));

localStorage.setItem("userRatedSkills", newFormatData);
